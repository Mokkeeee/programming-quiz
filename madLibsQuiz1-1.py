...
#My name: Evan Thong
#Who I collaborated with: Jennifer Jiang and Chen-Ha Ma
print(''' 
          ************************************
         |                                    |
         |        Welcome to MadLibs          | 
...
if play == "y": 
    ...
    sleeping bag, flashlight, and a {noun_1}. The possibility 
    of seeing a {animal_1} makes me feel {adjective_1}. I am excited to 
    go hiking on the {adjective_2} trail. If I see a {adjective_3} 
    {animal_2} on the hike, I will take it home as my new pet! The best 
    part of camping is eating {food} by the campfire!
    """)
